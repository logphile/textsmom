...
import destr, { destr as destr$1 } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/vue/index.mjs';
import { createHooks } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/youch-core/build/index.js';
import { Youch } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://H:/_Active/TextsMomv3/textsmom/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"H:/_Active/TextsMomv3/textsmom/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:/_Active/TextsMomv3/textsmom","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:/_Active/TextsMomv3/textsmom/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:/_Active/TextsMomv3/textsmom/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:/_Active/TextsMomv3/textsmom/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"H:/_Active/TextsMomv3/textsmom/.data/kv"}));
...
const _rnUUSmpA1gVjiJF_Vo2mly0sE75VYB5nXtTsYAz72Kk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "H:/_Active/TextsMomv3/textsmom";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"preload","as":"font","href":"/fonts/BebasNeue-Regular.woff2","type":"font/woff2","crossorigin":"anonymous"},{"rel":"preload","as":"font","href":"/fonts/Nunito-Regular.woff2","type":"font/woff2","crossorigin":"anonymous"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const _WX8osOuIYMOpY7DsHJLnxRsQzW4to65CVLd4Gv8uU = (nitroApp) => {
...
const plugins = [
  _rnUUSmpA1gVjiJF_Vo2mly0sE75VYB5nXtTsYAz72Kk,
...
const _AoJPBg = eventHandler((event) => {
...
const getServerEntry = () => import('file://H:/_Active/TextsMomv3/textsmom/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://H:/_Active/TextsMomv3/textsmom/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_kSU_yd, lazy: true, middleware: false, method: undefined }
];
...
const moderate_post = defineEventHandler(async (event) => {
  try {
    ...
    const customThresholds = {
      "hate": 0.8,
      // Very high threshold for hate speech
      "hate/threatening": 0.9,
      // Very high threshold for threatening hate
      "harassment": 0.95,
      // Almost never flag harassment (mom texts are confusing!)
      "harassment/threatening": 0.8,
      // High threshold for threatening harassment
      "self-harm": 0.7,
      // Moderate threshold for self-harm
      "self-harm/intent": 0.8,
      // High threshold for self-harm intent
      "self-harm/instructions": 0.9,
      // Very high threshold for self-harm instructions
      "sexual": 0.9,
      // Very high threshold for sexual content
      "sexual/minors": 0.5,
      // Keep strict for minors
      "violence": 0.8,
      // High threshold for violence
      "violence/graphic": 0.9
      // Very high threshold for graphic violence
    };
...
const reportPost_post = defineEventHandler(async (event) => {
  try {
    ...
    const emailContent = {
      ...
      to: "phoyce@gmail.com",
      subject: `\u{1F6A8} Post Reported - TextsMom Moderation Alert`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #FF6B6B; border-bottom: 3px solid #FF6B6B; padding-bottom: 10px;">
            \u{1F6A8} Post Reported - Moderation Required
          </h2>
          ...
          <div style="background: #fff3cd; padding: 20px; border-left: 4px solid #FF6B6B; margin: 20px 0; border-radius: 4px;">
            ...
            <p><strong>Reported At:</strong> ${(/* @__PURE__ */ new Date()).toLocaleString()}</p>
          </div>
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #666; font-size: 12px;">
            ...
            <p>Report submitted at ${(/* @__PURE__ */ new Date()).toLocaleString()}</p>
...
const reportPost_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: reportPost_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const sendEmail_post = defineEventHandler(async (event) => {
  try {
    ...
    const nodemailer = await import('file://H:/_Active/TextsMomv3/textsmom/node_modules/nodemailer/lib/nodemailer.js');
    ...
    const emailContent = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #666; font-size: 12px;">
            <p>This message was sent from the TextsMom contact form at ${(/* @__PURE__ */ new Date()).toLocaleString()}</p>
