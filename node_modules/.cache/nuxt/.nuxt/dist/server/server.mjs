...
import { hasProtocol, joinURL, withQuery, isScriptProtocol, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from "H:/_Active/TextsMomv3/textsmom/node_modules/ufo/dist/index.mjs";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C-pR1CQi.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Dk51HdfW.js"));
