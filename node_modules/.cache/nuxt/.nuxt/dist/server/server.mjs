import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, createElementBlock, shallowRef, resolveComponent, ref, provide, cloneVNode, toValue, onServerPrefetch, nextTick, unref, watch, withAsyncContext, mergeProps, withCtx, createVNode, createTextVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "H:/_Active/TextsMomv3/textsmom/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "H:/_Active/TextsMomv3/textsmom/node_modules/hookable/dist/index.mjs";
import { getContext } from "H:/_Active/TextsMomv3/textsmom/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "H:/_Active/TextsMomv3/textsmom/node_modules/h3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, isEqual, stringifyParsedURL, stringifyQuery, parseQuery, withTrailingSlash, withoutTrailingSlash } from "H:/_Active/TextsMomv3/textsmom/node_modules/ufo/dist/index.mjs";
import { toRouteMatcher, createRouter } from "H:/_Active/TextsMomv3/textsmom/node_modules/radix3/dist/index.mjs";
import { defu } from "H:/_Active/TextsMomv3/textsmom/node_modules/defu/dist/defu.mjs";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import "vue-toastification";
import { createClient } from "@supabase/supabase-js";
import { useHead as useHead$1, headSymbol } from "H:/_Active/TextsMomv3/textsmom/node_modules/@unhead/vue/dist/index.mjs";
import { debounce } from "H:/_Active/TextsMomv3/textsmom/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CmmQ_OeB.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BeYnhgjA.js"));
